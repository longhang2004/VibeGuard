    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center font-sans px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/40 border border-slate-800/80 p-8 rounded-3xl backdrop-blur-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="bg-gradient-to-tr from-indigo-500 to-purple-600 p-3 rounded-2xl shadow-xl shadow-indigo-500/15 mb-4">
          ...
          <p className="text-slate-500 text-xs mt-1.5">
            Log in to manage your AI contexts and scan code
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition text-sm outline-none text-slate-100 placeholder:text-slate-600"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 bg-indigo-600 hover:bg-indigo-500 active:scale-[0.98] disabled:opacity-50 text-white font-bold py-3 rounded-xl transition text-sm shadow-lg shadow-indigo-600/10 hover:shadow-indigo-500/20"
          >
